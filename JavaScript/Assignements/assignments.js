...
if (population > average) {
  ...
  console.log(
    `${country}'s population is ${average - population} below average.`
  );
}
...
const describePopulation = (country, population) => {
  console.log(
    `${country} has ${population} people, which is about ${percentageOfTheWorldArrow(
      population
    )}% of the world`
  );
};
...
console.log(
  `${myCountry.country} has ${myCountry.population} million arabic speaking people, ${myCountry.neighbours.length} countries and a capital called ${myCountry.capital}.`
);
...
const myCountry2 = {
  ...
  describe: function () {
    console.log(
      `${this.country} has ${this.population} million arabic speaking people, ${this.neighbours.length} countries and a capital called ${this.capital}.`
    );
  },
  isIsland: function () {
