...
const singleRecipe = async function () {
  try {
    ...
    //* LOADING RECIPE ///////////////
    const spinnerEl = spinner(recipeContainer)
    ...
    `;
    //Hidding message and inserting rmarkup
...
window.addEventListener('hashchange', singleRecipe)
window.addEventListener('load', singleRecipe)
